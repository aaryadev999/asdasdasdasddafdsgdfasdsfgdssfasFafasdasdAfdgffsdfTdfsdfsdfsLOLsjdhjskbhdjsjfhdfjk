...
function gotResults(error,results){
    ...
    document.getElementById("your_sketch").innerHTML = "Your Sketch Jhonny: "+results[0].label;
    document.getElementById("confidence").innerHTML = "Confidence Mumbo!!!: "+Math.round(results[0].confidence * 100)+"%";
